...
public final class QaseStepUtils {
     ...
     */
    public static <E extends Throwable> void updateStep(
        final ThrowingConsumer<ResultCreateStepsInner, ? extends E> updateConsumer
    ) throws E {
        if (updateConsumer == null) { throw new XtepsException("updateConsumer arg is null"); }
        updateConsumer.accept(StepStorage.getCurrentStep());
    }
}
