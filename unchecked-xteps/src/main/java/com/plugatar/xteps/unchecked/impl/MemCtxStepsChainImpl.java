...
public class MemCtxStepsChainImpl<C, P extends BaseCtxStepsChain<?, ?>> implements MemCtxStepsChain<C, P> {
    ...
    @Override
    public final MemCtxStepsChainImpl<C, P> supplyContext(final ThrowingConsumer<? super C, ?> consumer) {
    ...
    @Override
    public final <R> R applyContext(final ThrowingFunction<? super C, ? extends R, ?> function) {
    ...
    @Override
    public boolean testContext(final ThrowingPredicate<? super C, ?> predicate) {
    ...
    @Override
    public final <U> MemCtxStepsChain<U, MemCtxStepsChain<C, P>> withContext(
    ...
    @Override
    public final <U> MemCtxStepsChain<U, MemCtxStepsChain<C, P>> stepToContext(
    ...
    @Override
    public final MemCtxStepsChain<C, P> nestedSteps(final String stepName,
                                                    final ThrowingConsumer<MemCtxStepsChain<C, P>, ?> stepsChain) {
    ...
    public final <R> R nestedStepsTo(final String stepName,
                                     final ThrowingFunction<MemCtxStepsChain<C, P>, ? extends R, ?> stepsChain) {
    ...
    @Override
    public final MemCtxStepsChain<C, P> branchSteps(final ThrowingConsumer<MemCtxStepsChain<C, P>, ?> stepsChain) {
        if (stepsChain == null) { this.throwNullArgException("stepsChain"); }
        try {
            stepsChain.accept(this);
        } catch (final Throwable ex) {
    ...
    private <R> R reportStep(final String stepName,
        ...
        return this.stepReporter.report(
            this.safeACContainer, this.exceptionHandler, stepName, stepDescription, this.optionalContext,
