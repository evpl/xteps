...
public interface Mem1CtxStepsChain<C, P, PS extends BaseCtxStepsChain<?, ?>> extends
     ...
     */
    @Override
    <U> Mem2CtxStepsChain<U, C, P, Mem1CtxStepsChain<C, P, PS>> withContext(
     ...
     */
    @Override
    Mem1CtxStepsChain<C, P, PS> supplyContext(
     ...
     */
    @Override
    <U> Mem2CtxStepsChain<U, C, P, Mem1CtxStepsChain<C, P, PS>> stepToContext(
