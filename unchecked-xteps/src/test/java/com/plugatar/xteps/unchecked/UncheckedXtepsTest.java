...
final class UncheckedXtepsTest {
    ...
    @Test
    void stepMethod() {
        UncheckedXteps.step("stepMethod");
    ...
    void stepMethodWithDescription() {
        UncheckedXteps.step("stepMethodWithDescription", "stepMethodWithDescription description");
        assertThat(StaticStepListener.lastUUID()).matches(uuidPattern());
    ...
    void stepMethodWithAction() {
        ...
        UncheckedXteps.step("stepMethodWithAction", action);
        assertThat(StaticStepListener.lastUUID()).matches(uuidPattern());
    ...
    void stepMethodWithDescriptionAndAction() {
        ...
        UncheckedXteps.step("stepMethodWithDescriptionAndAction", "stepMethodWithDescriptionAndAction description", action);
        assertThat(StaticStepListener.lastUUID()).matches(uuidPattern());
    ...
    void stepToMethod() {
        ...
        assertThat(UncheckedXteps.stepTo("stepToMethod", action)).isSameAs(result);
        assertThat(StaticStepListener.lastUUID()).matches(uuidPattern());
    ...
    void stepToMethodWithDescription() {
        ...
        assertThat(UncheckedXteps.stepTo("stepToMethodWithDescription", "stepToMethodWithDescription description", action)).isSameAs(result);
        assertThat(StaticStepListener.lastUUID()).matches(uuidPattern());
