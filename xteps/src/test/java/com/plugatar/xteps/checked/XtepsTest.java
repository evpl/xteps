...
final class XtepsTest {
    ...
    void stepsChainMethod() {
        ...
        assertThat(Xteps.stepsChain()).isNotSameAs(stepsChain);
    ...
    void stepsChainOf1ArgMethod() {
        ...
        Xteps.stepsChainOf(arg1).step(stepName, action);
    ...
    void stepsChainOf2ArgMethod() {
        ...
        Xteps.stepsChainOf(arg1, arg2).step(stepName, action);
    ...
    void stepsChainOf3ArgMethod() {
        ...
        Xteps.stepsChainOf(arg1, arg2, arg3).step(stepName, action);
