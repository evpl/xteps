...
/**
 * Memorizing double context steps chain implementation.
 *
 * @param <C>  the context type
 * @param <C2> the second context type
 * @param <PS> the previous steps chain type
 */
public class Ctx2SCOf<C, C2, PS extends BaseSC<PS>> implements Ctx2SC<C, C2, PS> {
     ...
     */
    public Ctx2SCOf(final StepReporter stepReporter,
    ...
    @Override
    public final Ctx2SC<C, C2, PS> callChainHooks() {
        try {
    ...
    @Override
    public final Ctx2SC<C, C2, PS> chainHooksOrder(final HooksOrder order) {
    ...
    @Override
    public final Ctx2SC<C, C2, PS> threadHooksOrder(final HooksOrder order) {
        if (order == null) { this.throwNullArgException("order"); }
    ...
    @Override
    public final Ctx2SC<C, C2, PS> chainHook(
    ...
    @Override
    public final Ctx2SC<C, C2, PS> threadHook(
        final ThrowingRunnable<?> hook
    ) {
    ...
    @Override
    public final MemNoCtxSC<Ctx2SC<C, C2, PS>> withoutContext() {
        return new MemNoCtxSCOf<>(this.stepReporter, this.exceptionHandler, this.hooksContainer, this);
    }

    @Override
    public final <U> Ctx3SC<U, C, C2, Ctx2SC<C, C2, PS>> withCtx(final U context) {
        return this.newMem2CtxStepsChain(context);
    }

    @Override
    public final <U, E extends Throwable> Ctx3SC<U, C, C2, Ctx2SC<C, C2, PS>> withCtx(
    ...
    @Override
    public final <E extends Throwable> Ctx2SC<C, C2, PS> action(
    ...
    public final <U, E extends Throwable> Ctx3SC<U, C, C2, Ctx2SC<C, C2, PS>> withCtx(
        ...
        return this.newMem2CtxStepsChain(
            this.execAction(() -> function.apply(this.context, this.context2)));
    }

    @Override
    public final Ctx2SC<C, C2, PS> step(final String name) {
        return this.step(name, "");
    }

    @Override
    public final Ctx2SC<C, C2, PS> step(
        final String name,
        final String desc
    ) {
    ...
    @Override
    public final <E extends Throwable> Ctx2SC<C, C2, PS> step(
    ...
    @Override
    public final <U, E extends Throwable> Ctx3SC<U, C, C2, Ctx2SC<C, C2, PS>> stepToCtx(
    ...
    public final <R, E extends Throwable> R stepTo(
        ...
        if (desc == null) { this.throwNullArgException("desc"); }
        if (action == null) { this.throwNullArgException("action"); }
        return this.reportStep(name, desc, () -> action.apply(this.context, this.context2));
    }

    @Override
    public final <E extends Throwable> Ctx2SC<C, C2, PS> nestedSteps(
        final ThrowingConsumer<Ctx2SC<C, C2, PS>, ? extends E> stepsChain
    ) throws E {
    ...
    public final <R, E extends Throwable> R nestedStepsTo(
        final ThrowingFunction<Ctx2SC<C, C2, PS>, ? extends R, ? extends E> stepsChain
    ) throws E {
    ...
    @Override
    public final <E extends Throwable> Ctx2SC<C, C2, PS> branchSteps(
        final ThrowingConsumer<Ctx2SC<C, C2, PS>, ? extends E> stepsChain
    ) throws E {
        if (stepsChain == null) { this.throwNullArgException("stepsChain"); }
        this.execAction(() -> {
    ...
    private <R, E extends Throwable> R reportStep(
        ...
        return this.stepReporter.report(this.hooksContainer, this.exceptionHandler, stepName, stepDescription,
            new Object[]{this.context, this.context2}, step);
    }
    ...
    private <U> Ctx3SC<U, C, C2, Ctx2SC<C, C2, PS>> newMem2CtxStepsChain(final U newContext) {
